<?php
	...
	class TablaResponsivas2
	{
		// Mostrar la tabla de Responsivas
		public function mostrarTablaResponsivas2()
		{
			...
			// Comienza a generar los datos JSon.
			 $datosJson = '{
				...
				for ($i =0;$i<count($responsivas);$i++)
				{
					...
					if ((isset($_GET["perfilOculto"]) && $_GET["perfilOculto"] == "Admin") || $_GET["perfilOculto"] == "Administrado")
					{
						$botones = "<div class='btn-group'><button class='btn btn-primary agregarResponsiva recuperarBotonEmp' idResponsiva='".$responsivas[$i]["id_responsiva"]."'>Agregar </button></div>";
					}
					else
					{
						$botones = "<div class='btn-group'><button class='btn btn-primary agregarResponsiva recuperarBotonEmp' idResponsiva='".$responsivas[$i]["id_responsiva"]."'>Agregar </button></div>";
	...
	$activarResponsivas2 = new TablaResponsivas2();
	$activarResponsivas2->mostrarTablaResponsivas2();
